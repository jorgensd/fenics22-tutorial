...
# + [markdown] slideshow={"slide_type": "slide"} tags=[] jp-MarkdownHeadingCollapsed=true slideshow={"slide_type": "slide"} tags=[]
...
# + tags=["ignore-output", "hide-input", "hide-output"]
...
# + tags=["hide-input"] language="html"
# <iframe src='./Abs(u).html' scrolling="no" onload='javascript:(function(o){o.style.height=o.contentWindow.document.body.scrollHeight+"px";}(this));' style="height:700px;width:100%;border:none;overflow:hidden;"></iframe> <!--  # noqa, >
